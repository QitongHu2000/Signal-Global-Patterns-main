...
times = load_dict('R_BA_global_time_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
weights_hens = load_dict('R_BA_global_degree_hens_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
weights_L = load_dict('R_BA_global_degree_L_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
weights_multi_hens = load_dict('R_BA_global_degree_multi_hens_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
weights_multi = load_dict('R_BA_global_degree_multi_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]

times=[i for (k,i) in enumerate(times) if k!=source]
weights_hens=[i for (k,i) in enumerate(weights_hens) if k!=source]
...
pearsonr_hens=str(round(scipy.stats.pearsonr(weights_hens, times)[0],2))
spearmanr_hens=str(round(scipy.stats.spearmanr(weights_hens, times)[0],2))
...
pearsonr_multi_hens=str(round(scipy.stats.spearmanr(weights_multi_hens, times)[0],2))
spearmanr_multi_hens=str(round(scipy.stats.spearmanr(weights_multi_hens, times)[0],2))
...
pearsonr_multi=str(round(scipy.stats.spearmanr(weights_multi, times)[0],2))
spearmanr_multi=str(round(scipy.stats.spearmanr(weights_multi, times)[0],2))
rr_multi=str(round(goodness_of_fit([fit_k_multi * i for i in weights_multi],times),2))
...
plt.tight_layout()
plt.axis('equal')
plt.savefig('R_BA_global_multi'+str(int(100*a))+'_'+str(int(100*b))+'.pdf',dpi=300)
plt.show()