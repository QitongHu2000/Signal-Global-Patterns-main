...
def H2(x):
    return alpha * np.power(x,b)/(1+np.power(x,b))
...
def H2_(x):
    return alpha * b*np.power(x,b-1)/(1+np.power(x,b))**2

def C_(x):
    return alpha * b*np.power(x,b-1)/(1+np.power(x,b))**2/(a*np.power(x,a-1))
...
k=1
sources=[5, ] #np.random.choice(G_edge.nodes,k)#172
...
save_dict(np.mat(times_simulation_times), 'R_BA_global_time_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(theory_times_hens), 'R_BA_global_degree_hens_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(theory_times_L), 'R_BA_global_degree_L_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(theory_times_multi_hens), 'R_BA_global_degree_multi_hens_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(theory_times_multi), 'R_BA_global_degree_multi_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(np.mat(theory_times_multi_weight), 'R_BA_global_degree_multi_weight_'+str(int(100*a))+'_'+str(int(100*b)))