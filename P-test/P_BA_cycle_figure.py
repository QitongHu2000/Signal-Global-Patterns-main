...
if __name__ == '__main__':
    ...
    theory_time_ours = load_dict('P_BA_global_degree_multi_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]

    signal=signal_propagation(t_selected)
    scale,xs=signal.simulation(A)
    
    colors3 = ['#8DDFBF', '#328CA0']
    path3 = 'P_BA_{}_distance_network_ours.pdf'.format(int(100*t_selected))
    dis3=1
