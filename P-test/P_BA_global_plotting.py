...
times = load_dict('P_BA_global_time_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
weights_hens = load_dict('P_BA_global_degree_hens_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
weights_L = load_dict('P_BA_global_degree_L_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
weights_multi_hens = load_dict('P_BA_global_degree_multi_hens_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
weights_multi = load_dict('P_BA_global_degree_multi_'+str(int(100*a))+'_'+str(int(100*b))).tolist()[0]
...
plt.tight_layout()
plt.axis('equal')
plt.savefig('P_BA_global_multi'+str(int(100*a))+'_'+str(int(100*b))+'.pdf',dpi=300)
plt.show()