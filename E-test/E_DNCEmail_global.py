...
k=1
sources=[1779, ] #np.random.choice(G_edge.nodes,k) #[196, 55, 107]
...
save_dict(np.mat(times_simulation_times), 'E_DNCEmail_global_time_'+str(int(100*B)))
save_dict(np.mat(theory_times_hens), 'E_DNCEmail_global_degree_hens_'+str(int(100*B)))
save_dict(np.mat(theory_times_L), 'E_DNCEmail_global_degree_L_'+str(int(100*B)))
save_dict(np.mat(theory_times_multi_hens), 'E_DNCEmail_global_degree_multi_hens_'+str(int(100*B)))
save_dict(np.mat(theory_times_multi), 'E_DNCEmail_global_degree_multi_'+str(int(100*B)))
save_dict(np.mat(theory_times_multi_weight), 'E_DNCEmail_global_degree_multi_weight_'+str(int(100*B)))