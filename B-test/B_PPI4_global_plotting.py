...
times = load_dict('B_PPI4_global_time_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
weights_hens = load_dict('B_PPI4_global_degree_hens_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
weights_L = load_dict('B_PPI4_global_degree_L_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
weights_multi_hens = load_dict('B_PPI4_global_degree_multi_hens_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
weights_multi = load_dict('B_PPI4_global_degree_multi_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
...
plt.tight_layout()
plt.axis('equal')
plt.savefig('B_PPI4_large_global_multi_'+str(int(100*B))+'.pdf',dpi=300)
plt.show()