...
k=1
sources=[657, ] #np.random.choice(G_edge.nodes,k) #[196, 55, 107]
...
save_dict(np.mat(times_simulation_times), 'B_PPI2_global_time_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(theory_times_hens), 'B_PPI2_global_degree_hens_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(theory_times_L), 'B_PPI2_global_degree_L_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(theory_times_multi_hens), 'B_PPI2_global_degree_multi_hens_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(theory_times_multi), 'B_PPI2_global_degree_multi_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(np.mat(theory_times_multi_weight), 'B_PPI2_global_degree_multi_weight_'+str(int(100*B))+'_'+str(int(100*C)))