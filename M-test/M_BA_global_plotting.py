...
times = load_dict('M_BA_global_time_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
weights_hens = load_dict('M_BA_global_degree_hens_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
weights_L = load_dict('M_BA_global_degree_L_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
weights_multi_hens = load_dict('M_BA_global_degree_multi_hens_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
weights_multi = load_dict('M_BA_global_degree_multi_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
...
pearsonr_multi_hens=str(round(scipy.stats.pearsonr(weights_multi_hens, times)[0],2))
...
pearsonr_multi=str(round(scipy.stats.pearsonr(weights_multi, times)[0],2))
...
plt.tight_layout()
plt.axis('equal')
plt.savefig('M_BA_global_multi_'+str(int(100*B))+'_'+str(int(100*C))+'.pdf',dpi=300)
plt.show()